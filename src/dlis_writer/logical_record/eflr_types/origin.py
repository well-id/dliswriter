...
class OriginItem(EFLRItem):
    ...
    def __init__(self, name: str, file_set_number: int, **kwargs: Any) -> None:
        ...
        self.order_number = TextAttribute('order_number', parent_eflr=self)
        ...
        self.well_name = TextAttribute('well_name', parent_eflr=self)
        self.field_name = TextAttribute('field_name', parent_eflr=self)
